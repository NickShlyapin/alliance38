...
export default function ContactInt() {
  return (
    <>
      <Head>
        <title>АльянсАвто — Контактная информация</title>
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta name="description" content="г. Иркутск, Ширямова 13/5" />
        <meta
          name="keywords"
        ...
        <meta property="og:url" content="https://alliance38.ru/contactInfo" />
        <meta property="og:title" content="АльянсАвто" />
        <meta
          property="og:description"
          content="АльянсАвто — Контактная информация"
        />
